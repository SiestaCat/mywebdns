...
define("_DomainRecoverError","Recupero impossibile. Questo dominio gi� esiste");
define("_DomainRegError","Dominio gi� esistente");
define("_DNSError","Nessun DNS configurato");
define("_DNSRegError","DNS gi� registrato");
...
define("_TLDError","Il dominio inserito non � riconosciuto");
